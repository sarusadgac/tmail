    ...
    @elseif ($current === 1)
        ...
        <div class="col-span-6">
            <div class="bg-green-100 dark:bg-green-900 border border-green-400 text-green-700 dark:text-green-300 px-4 py-3 rounded">
                <p><strong>TMail v8.0.2:</strong> {{ __('License verification has been bypassed. You can proceed with the installation.') }}</p>
                <small>{{ __('No purchase code required - system automatically configured for v8.0.2.') }}</small>
            </div>
        </div>
    @elseif ($current === 2)
        <div class="col-span-6">
