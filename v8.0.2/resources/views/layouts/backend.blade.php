                ...
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-col-reverse md:flex-row justify-between items-center gap-5">
                        ...
                        <div class="flex gap-5 text-sm">
                            ...
                            <a class="border-b border-transparent hover:border-gray-100" href="https://noref.to/?https://helpdesk.thehp.in" target="_blank" rel="noopener noreferrer">{{ __("Contact Support") }}</a>
                        </div>
                    </div>
                </div>
            </footer>
