...
class Util {
    ...
    /** Check for Update - License control removed - v8.0.2 */
    public static function checkForAppUpdate() {
        // Auto update service disabled - License system removed for v8.0.2
        try {
            return [
                'available' => false,
                'disabled' => true,
                'error' => false,
                'message' => 'Auto update service disabled - License system removed for v8.0.2. Manual updates only.'
            ];
        } catch (Exception $e) {
