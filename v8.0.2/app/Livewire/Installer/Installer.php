...
class Installer extends Component {
    ...
    public function save() {
        ...
        if ($this->current === 0) {
            ...
            // License control bypassed - v8.0.2
            Artisan::call('db:seed', ['--force' => true]);
            Artisan::call('storage:link', ['--force' => true]);
            $this->current = 2;
            Setting::put('name', $this->state['app_name']);
            Setting::put('license_key', 'tmail-v802-license-bypassed');
            $this->success = 'License verification bypassed for TMail v8.0.2.';
    ...
    /** License Key Check - BYPASSED v8.0.2 */
    private function checkLicense() {
        // License control completely removed - TMail v8.0.2
        try {
            Artisan::call('db:seed', ['--force' => true]);
            Artisan::call('storage:link', ['--force' => true]);
            $this->success = 'License verification bypassed for TMail v8.0.2.';
