...
class Auto extends Component {
    ...
    public function mount() {
        // Auto update service disabled - v8.0.0
        $this->status = [
            'available' => false,
            'disabled' => true,
            'message' => 'Auto update service disabled - License system removed for v8.0.0',
        ];
    }

    /** Apply Update - DISABLED for v8.0.0 */
    public function apply($step = 0) {
        // Auto update system disabled - v8.0.0
        $this->progress .= '<div class="text-yellow-500">Auto update system disabled for v8.0.0</div>';
