                ...
                <div class="bg-gray-50 text-gray-800 grid gap-5 grid-cols-1 md:grid-cols-3 px-20 py-10">
                    <div>
                        <div class="flex items-center">
                            <div class="text-lg leading-7 font-semibold"><a href="https://noref.to/?https://helpdesk.thehp.in/help-center/categories/2/tmail" target="_blank">{{ __('Articles') }}</a></div>
                        </div>
                        <div class="">
                            ...
                            <a href="https://noref.to/?https://helpdesk.thehp.in/help-center/categories/2/tmail" target="_blank">
                    ...
                    <div>
                        <div class="flex items-center">
                            <div class="text-lg leading-7 font-semibold"><a href="https://noref.to/?https://helpdesk.thehp.in/help-center/tickets/new" target="_blank">{{ __('Support') }}</a></div>
                        </div>
                        <div class="">
                            <div class="mt-2 text-sm">
                            ...
                            <a href="https://noref.to/?https://helpdesk.thehp.in/help-center/tickets/new" target="_blank">
                                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                    ...
                    <div>
                        ...
                        <div class="">
                            <div class="mt-2 text-sm">
                                {{ __('TMail now supports Themes that opens the door for unlimited possibilities like making your TMail just the way you want without impacting the codebase.') }}
                            </div>
