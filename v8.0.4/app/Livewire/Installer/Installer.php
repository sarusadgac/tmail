...
class Installer extends Component {
    ...
    public function save() {
        ...
        if ($this->current === 0) {
            ...
            // License verification bypassed for v8.0.4
            Artisan::call('db:seed', ['--force' => true]);
            Artisan::call('storage:link', ['--force' => true]);
            $this->success = 'License verification bypassed. Please enter the IMAP Details.';
            $this->current = 2;
            Setting::put('name', $this->state['app_name']);
            Setting::put('license_key', $this->state['license_key'] ?? 'tmail-v804-license-bypassed');
    ...
    /** License Key Check - BYPASSED for v8.0.4 */
